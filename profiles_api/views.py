""" 
Basic Requirements for Creating a Profile:
1. Create new profile
    - Handle registration of new users
    - Validate profile data
2. Listing existing profiles
    - Search for profiles by email and name
3. View specific prpfiles
    - profile ID
4. Update profile of logged in used
...
Basic Requirements for Feed API

1. Create new feed items
    - logged in user only
...
class HelloAPIView(APIView):
    ...
    def get(self, request, format=None):
        ...
        an_apiview = [
            ...
            'Give you the most control over you appplication logic',
...
class HelloViewSet(viewsets.ViewSet):
    ...
    def create(self, request):      #POST http_method
...
class UserLoginApiView(ObtainAuthToken):
    """ Handle creating authentiation tokens """
